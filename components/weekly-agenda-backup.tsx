...
function WeeklyAgendaContent({
  ...
  // ✅ REMOVIDO: Verificaciones de isLoadingClinic que causaban spinners en navegación
  // El sistema de cache debe mostrar datos inmediatamente si están disponibles
